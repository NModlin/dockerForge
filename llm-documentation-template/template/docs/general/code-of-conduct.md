...
<!-- 
@llm-instructions
DOCUMENT PURPOSE: Define standards for community participation
PRIMARY AUDIENCE: All community members
MAINTENANCE PRIORITY: High (community health document)
...
<!-- @llm-update-section
The contact method should be updated when the project establishes an official channel for Code of Conduct reports.
Replace [CONTACT METHOD] with the appropriate contact method (email, form, etc.).
-->
