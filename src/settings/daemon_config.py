...
class DaemonConfigManager:
    ...
    def __init__(self, config_manager: ConfigManager):
        ...
        self.daemon_json_path = self.config.get('docker', {}).get('daemon_json_path', DEFAULT_DAEMON_JSON_PATH)
    ...
    def get_daemon_config(self) -> Dict[str, Any]:
        ...
        try:
            if os.path.exists(self.daemon_json_path):
                ...
                logger.warning(f"Daemon configuration file {self.daemon_json_path} does not exist")
                return {}
    ...
    def update_daemon_config(self, config: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        try:
            ...
            if not restart_success:
                return False, f"Configuration updated but failed to restart Docker: {restart_message}"
    ...
    def get_registry_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "allow-nondistributable-artifacts": daemon_config.get("allow-nondistributable-artifacts", [])
        }
    
    def update_registry_config(self, registry_config: Dict[str, Any]) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            daemon_config["registry-mirrors"] = registry_config.get("registry-mirrors", [])
            daemon_config["insecure-registries"] = registry_config.get("insecure-registries", [])
            daemon_config["allow-nondistributable-artifacts"] = registry_config.get("allow-nondistributable-artifacts", [])
    ...
    def update_network_config(self, network_config: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        try:
            ...
            network_fields = [
                "default-address-pools", "dns", "dns-opts", "dns-search",
                "bip", "fixed-cidr", "fixed-cidr-v6", "default-gateway",
                "default-gateway-v6", "ip-forward", "ip-masq", "iptables", "ipv6"
            ]
    ...
    def _execute_command(self, cmd: List[str], use_sudo: bool = False) -> Tuple[bool, str, str]:
        """
