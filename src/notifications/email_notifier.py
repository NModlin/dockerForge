...
class EmailNotifier:
    ...
    def _create_email_message(self, notification: Notification) -> MIMEMultipart:
        ...
        html_content = self._template_manager.render_template(template_id, "html", context)
        ...
        if html_content:
            ...
            text_content = self._template_manager.render_template(template_id, "text", context)
            ...
            if text_content:
                ...
                # Use default text
                text_part = MIMEText(f"{notification.title}\n\n{notification.message}", "plain")
                message.attach(text_part)
