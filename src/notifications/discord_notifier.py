...
class DiscordNotifier:
    ...
    def _get_discord_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "username": get_config("notifications.channels.discord.username", "DockerForge"),
    ...
    def _create_discord_webhook(self, notification: Notification) -> Optional[DiscordWebhook]:
        ...
        discord_content = self._template_manager.render_template(template_id, "discord", context)
