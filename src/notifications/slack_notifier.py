...
class SlackNotifier:
    ...
    def _get_slack_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "channel": get_config("notifications.channels.slack.channel", "#docker-alerts"),
            "username": get_config("notifications.channels.slack.username", "DockerForge"),
            "icon_emoji": get_config("notifications.channels.slack.icon_emoji", ":whale:"),
        }
    ...
    def _create_slack_payload(self, notification: Notification) -> Dict[str, Any]:
        ...
        slack_content = self._template_manager.render_template(template_id, "slack", context)
