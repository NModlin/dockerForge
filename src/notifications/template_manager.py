...
class NotificationTemplate:
    ...
    def render(self, template_type: str, context: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            # Add custom filters
            env.filters['datetime'] = lambda dt, format='%Y-%m-%d %H:%M:%S': dt.strftime(format) if dt else ''
...
class TemplateManager:
    ...
    def __init__(self):
        ...
        # Add custom filters
        self._jinja_env.filters['datetime'] = lambda dt, format='%Y-%m-%d %H:%M:%S': dt.strftime(format) if dt else ''
    ...
    def _load_templates(self) -> None:
        ...
        templates_dir = os.path.expanduser(get_config("notifications.templates.directory", "~/.dockerforge/notification_templates"))
    ...
    def render_template(self, template_id: str, template_type: str, context: Dict[str, Any]) -> Optional[str]:
