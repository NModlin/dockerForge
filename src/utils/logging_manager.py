...
class LoggingManager:
    ...
    def setup_logging(self) -> None:
        ...
        log_format = self.DETAILED_LOG_FORMAT if log_level_name == "DEBUG" else self.DEFAULT_LOG_FORMAT
        ...
        if log_file:
            ...
            if log_dir and not os.path.exists(log_dir):
                try:
                    ...
                    self.app_logger.warning(f"Could not create log directory {log_dir}: {str(e)}")
                    return
            ...
            try:
                ...
                self.app_logger.warning(f"Could not set up log file {log_file}: {str(e)}")
