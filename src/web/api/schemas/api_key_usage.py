...
class ApiKeyUsageSummaryBase(BaseModel):
    ...
    total_response_size: int = Field(..., description="Total size of responses in bytes")
    endpoints: Optional[Dict[str, int]] = Field(None, description="Dictionary of endpoints and request counts")
...
class ApiKeyUsageStats(BaseModel):
    ...
    top_endpoints: List[Dict[str, Any]] = Field(..., description="Top endpoints by request count")
    usage_over_time: List[Dict[str, Any]] = Field(..., description="Usage over time (daily)")
