...
class LogFilter(BaseModel):
    ...
    stream: Optional[LogStream] = Field(None, description="Filter by stream (for containers)")
...
class LogStatistics(BaseModel):
    ...
    by_stream: Optional[Dict[LogStream, int]] = Field(None, description="Logs by stream (for containers)")
