...
class NetworkBase(BaseModel):
    ...
    driver: str = Field("bridge", description="Network driver (bridge, host, overlay, macvlan, ipvlan, etc.)")
    ...
    options: Optional[Dict[str, str]] = Field(None, description="Network driver options")
...
class NetworkCreate(NetworkBase):
    ...
    """
    subnet: Optional[str] = Field(None, description="Network subnet (e.g., 172.18.0.0/16)")
    gateway: Optional[str] = Field(None, description="Network gateway (e.g., 172.18.0.1)")
...
class Network(NetworkBase):
    ...
    containers: Optional[List[NetworkContainer]] = Field(None, description="Connected containers")
