...
def get_host_metrics_collector() -> HostMetricsCollector:
    ...
    if _host_metrics_collector is None:
        ...
        _host_metrics_collector = HostMetricsCollector(config_manager, connection_manager)
...
async def get_resource_stats_summary() -> Dict[str, Any]:
    ...
    try:
        ...
        # Get container stats
        containers = []
        for container in docker_client.containers.list(all=False):  # Only running containers
            try:
                # Get container stats
