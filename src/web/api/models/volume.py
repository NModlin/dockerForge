...
class Volume(BaseModel, TimestampMixin):
    ...
    status = Column(String(20), nullable=False, default='available')  # available, in-use, error
    ...
    # Relationships
    volume_mounts = relationship("VolumeMount", back_populates="volume", cascade="all, delete-orphan")
