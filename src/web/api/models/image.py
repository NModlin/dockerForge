...
class Image(BaseModel, TimestampMixin):
    ...
    created_at_docker = Column(DateTime, nullable=True)  # When the image was created in Docker
    ...
    security_scans = relationship("SecurityScan", back_populates="image", cascade="all, delete-orphan")
...
class SecurityScan(BaseModel, TimestampMixin):
    ...
    scan_type = Column(String(50), nullable=False)  # e.g., 'vulnerability', 'compliance'
