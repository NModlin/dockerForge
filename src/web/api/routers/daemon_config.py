...
from src.web.api.schemas.daemon_config import (
    DaemonConfig, RegistryConfig, LoggingConfig, StorageConfig, NetworkConfig,
    DriverInfo, AvailableDrivers, ConfigUpdateResponse
)
    ...
    try:
        ...
        return {
            "registry": {
                ...
                "allow-nondistributable-artifacts": registry_config.get("allow-nondistributable-artifacts", [])
            },
            "logging": {
...
async def get_available_drivers(
    ...
    try:
        ...
        logging_driver_info = [
            {
                "name": "json-file",
                "description": "JSON File logging driver"
            },
            {
                "name": "syslog",
                "description": "Syslog logging driver"
            },
            {
                "name": "journald",
                "description": "Journald logging driver"
            },
            {
                "name": "gelf",
                "description": "GELF (Graylog) logging driver"
            },
            {
                "name": "fluentd",
                "description": "Fluentd logging driver"
            },
            {
                "name": "awslogs",
                "description": "Amazon CloudWatch Logs logging driver"
            },
            {
                "name": "splunk",
                "description": "Splunk logging driver"
            },
            {
                "name": "etwlogs",
                "description": "ETW logging driver (Windows)"
            },
            {
                "name": "gcplogs",
                "description": "Google Cloud Logging driver"
            },
            {
                "name": "logentries",
                "description": "Logentries logging driver"
            },
            {
                "name": "local",
                "description": "Local file logging driver"
            }
        ]
        ...
        storage_driver_info = [
            {
                "name": "overlay2",
                "description": "OverlayFS v2 storage driver"
            },
            {
                "name": "aufs",
                "description": "AUFS storage driver"
            },
            {
                "name": "btrfs",
                "description": "Btrfs storage driver"
            },
            {
                "name": "devicemapper",
                "description": "Device Mapper storage driver"
            },
            {
                "name": "vfs",
                "description": "VFS storage driver"
            },
            {
                "name": "zfs",
                "description": "ZFS storage driver"
            }
        ]
        
        # Filter to only include available drivers
        logging_driver_info = [d for d in logging_driver_info if d["name"] in logging_drivers]
        storage_driver_info = [d for d in storage_driver_info if d["name"] in storage_drivers]
