...
from src.web.api.services.stats import (
    get_container_stats,
...
async def get_stats_history(
    ...
    metric_type: Optional[str] = Query(
        None, description="Metric type (cpu, memory, network, disk)"
    ),
    hours: int = Query(
    ...
    stats = await get_container_stats_history(
        container_id, metric_type, start_time, end_time, db
    )
