...
class BackupManager:
    ...
    def __init__(self):
        ...
        self.backup_dir = self.config.get("backup_dir", os.path.expanduser("~/.dockerforge/backups"))
        ...
        for mount in mounts:
            try:
                ...
                try:
                    ...
                    with open(os.path.join(volume_backup_path, "volume_info.json"), "w") as f:
        ...
        try:
            ...
            if volume_map:
                ...
                for mount in host_config.get("Mounts", []):
                    if mount.get("Type") == "volume" and mount.get("Name") in volume_map:
    ...
    def _restore_volumes(self, volume_backups: List[Dict[str, Any]]) -> Dict[str, str]:
        ...
        for volume_backup in volume_backups:
            try:
                ...
                logger.error(f"Error restoring volume {volume_backup.get('volume_name')}: {str(e)}")
