...
class TestSecurityAudit:
    ...
    def test_csrf_protection(self):
        ...
        for endpoint in csrf_endpoints:
            ...
            try:
                ...
                assert response.status_code in [401, 403, 422], f"Endpoint {endpoint} does not have CSRF protection"
            except Exception:
    ...
    def test_api_key_security(self):
        ...
        if hasattr(app, "api_key_auth"):
            ...
            response = self.client.get("/monitoring/host/metrics", headers={"X-API-Key": "invalid-key"})
            
            # Check that the request was unauthorized
            assert response.status_code in [401, 403], "API key authentication is not secure"
